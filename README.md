...
1.reprocessing & Vectorization: Map labels to binary values (0 and 1) and add a "bias" column of ones to the feature matrix X to allow for an intercept.
...
<img width="821" height="603" alt="image" src="https://github.com/user-attachments/assets/38ebaecb-e7bd-4c59-8fbe-80301786cedf" />
